...
declare module "ipc" {
     ...
     */
    export function send(port: number, msg: any, opts?: SendOptions): void;
     ...
     */
    export function receive(port: number, opts?: ReceiveOptions): IpcMessage;
     ...
     */
    export function close(port: number): void;
     ...
     * @throws EINTERNAL: Right points to invalid port
     */
    export function stat(port: number): IpcStat;
}